...
#### 예외 처리
- [x] 구분자를 기준으로 숫자가 아닌 다른 문자를 입력한 경우 예외처리
    - "i,j,2", "#,3,4"
- [x] 커스텀 구분자 지정을 잘못 지정하여 입력한 경우 예외 처리
    - "::i\n1i2i3"
- [x] 기본 구분자가 아닌 다른 구분자를 커스텀 지정 없이 입력한 경우 예외처리
    - "1.2.3","1@3^4"
- [x] 기본 구분자 이외에 다른 구분자를 혼합하여 입력한 경우 예외처리
    - "1,2\*3", "2:3,4\*5"
- [x] 구분자 사이에 공백 넣어 입력한 경우 예외처리
    - "1, 2, 3", "1 , 2 , 3"
- [x] 음수를 입력한 경우 예외처리

#### 기능 단위 테스트 - add 기능 테스트에 집중하기 !!
- [x] 입력한 값 유효성 검사 - 예외처리 테스트
